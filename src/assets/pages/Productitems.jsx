        ...
        <div className='p-[20px]'>
          <div className='text-white rounded-[10px] opacity-80 border  border-slate-500 overflow-hidden'>
            ...
            <div className='p-[15px] overflow-auto'>
              <table className='w-[1200px] rounded-[10px] overflow-hidden'>
                <tr className='border-b-[1px] border-slate-500'>
                  ...
                  <th className='text-left p-[10px] font-bold text-[18px]'>Category Name</th>
                  <th className='text-left p-[10px] font-bold text-[18px]'>Image</th>
                  <th className='text-left p-[10px] font-bold text-[18px]'>Description</th>
