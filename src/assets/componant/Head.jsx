    ...
    <>
      <header className='border-b-[1px] border-slate-600 text-white opacity-80 p-[8px_20px] flex justify-between'>
        <div className='flex items-center text-[19] gap-[15px]'>
          {winwidth <= 400 ? (
            <i
              className='cursor-pointer border border-slate-500 rounded-[8px] p-[6px]'
              onClick={() => {
                contextdata.setshow('0%')
              }}
            >
        ...
        <div className='flex items-center gap-[20px]'>
          <small>USER:ID- Akshay2906@129</small>
          <img
            className='rounded-[40%] cursor-pointer'
            width={'40px'}
            src={rdj}
            alt=''
          />
